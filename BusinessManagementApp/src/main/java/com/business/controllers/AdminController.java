...
import com.business.service.AdminServices;
import com.business.service.OrderServices;
...
public class AdminController {
	...
	public String orderHandler(@ModelAttribute Orders order, Model model) 
	{
	    ...
	    product.setPName(order.getOName());
	    product.setPPrice(order.getOPrice());
	    model.addAttribute("product", product);


	    if (order.getUser() != null) 
	    {
	        model.addAttribute("name", order.getUser().getUName());
	    } 
	    else
	    {
	        model.addAttribute("name", "Customer"); // fallback
	    }
